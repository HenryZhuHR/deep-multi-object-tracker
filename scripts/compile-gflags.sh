...
if  [ -d "$install_dir/$package_name/lib/cmake/gflags" ]; then
...
export GFLAGS_HOME=$install_dir/$package_name
export CMAKE_PREFIX_PATH=$CMAKE_PREFIX_PATH:$GFLAGS_HOME/lib/cmake/gflags
